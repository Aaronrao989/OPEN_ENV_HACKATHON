...
This module creates an HTTP server that exposes the EmailEnvironment
...
try:
    from models import Action as EmailAction, Observation as EmailObservation
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    multiple workers:
        uvicorn email_env.server.app:app --workers 4
    """
    import uvicorn
